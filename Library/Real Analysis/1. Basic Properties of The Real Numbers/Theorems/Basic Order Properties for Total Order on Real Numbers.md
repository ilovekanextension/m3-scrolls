...
- **Case** $a<b$. This means $a+c<b+c$, so $a+c\leq b+c$.
...
- **Case** $a<b$. If $0<c$, then $a\cdot c<b\cdot c$, so $a\cdot c\leq b\cdot c$. If $0=c$, then by [[Multiplications with Ring Zeros]] $$a\cdot c=a\cdot 0=0=b\cdot 0=b\cdot c,$$so $a\cdot c\leq b\cdot c$.
